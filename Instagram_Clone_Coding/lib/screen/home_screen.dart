...
final feedDataList = [
  FeedData(userName: 'User1', likeCount: 50, content: '오늘 점심이 좋았다'),
  FeedData(userName: 'User2', likeCount: 30, content: '오늘 오늘이 맛있었다'),
  FeedData(userName: 'User3', likeCount: 33, content: '요즘 맨날 개발 공부중'),
  FeedData(userName: 'User4', likeCount: 99, content: '올해 성장하자!'),
  FeedData(userName: 'User5', likeCount: 93, content: '성장하자 가즈아~~~'),
  FeedData(userName: 'User6', likeCount: 72, content: '노페인 노게인'),
  FeedData(userName: 'User7', likeCount: 51, content: '수신제가치국평천하'),
];
